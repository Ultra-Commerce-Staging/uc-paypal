 ...
 * #L%
 */
package com.ultracommerce.vendor.paypal.web.controller;
 ...
 */
@Controller("ucPayPalCheckoutController")
@RequestMapping("/" + UltraPayPalCheckoutController.GATEWAY_CONTEXT_KEY)
public class UltraPayPalCheckoutController extends PaymentGatewayAbstractController {

    private static final Log LOG = LogFactory.getLog(UltraPayPalCheckoutController.class);
